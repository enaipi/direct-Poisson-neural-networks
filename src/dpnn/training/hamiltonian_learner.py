...
from dpnn.utils.jacobi_identity import (
    compute_jacobi_loss,
    jacobi_loss_forward,
...
class HamiltonianLearner:
    ...
    def jacobi_loss(self, z_n: torch.Tensor) -> torch.Tensor:
        ...
        Routes based on self.jacobi_loss_mode using dpnn.utils.jacobi_identity.
        """
        if self.use_constant_L:
            # Constant antisymmetric matrices satisfy Jacobi identically
            return torch.zeros((), device=z_n.device, dtype=z_n.dtype)
        
        get_jacobian_func = getattr(self.L_tensor, "get_jacobian", None) if hasattr(self, "L_tensor") else None
        return compute_jacobi_loss(
            self._forward_L_tensor_for_jacobi,
            z_n,
            mode=self.jacobi_loss_mode,
            num_samples=self.hutchinson_samples,
            get_jacobian_func=get_jacobian_func,
        )
    ...
    def jacobi_loss_forward(self, z_n: torch.Tensor) -> torch.Tensor:
        ...
        return jacobi_loss_forward(self._forward_L_tensor_for_jacobi, z_n)
    ...
    def jacobi_loss_hutchinson(self, z_n: torch.Tensor) -> torch.Tensor:
        ...
        return jacobi_loss_hutchinson(self._forward_L_tensor_for_jacobi, z_n, num_samples=self.hutchinson_samples)
    ...
    def jacobi_loss_hutchinson_batched(self, z_n: torch.Tensor) -> torch.Tensor:
        ...
        return jacobi_loss_hutchinson_batched(self._forward_L_tensor_for_jacobi, z_n, num_samples=self.hutchinson_samples)
    ...
    def jacobi_loss_spectral(self, z_n: torch.Tensor) -> torch.Tensor:
        ...
        return jacobi_loss_spectral(self._forward_L_tensor_for_jacobi, z_n, num_iterations=self.hutchinson_samples)
    ...
    def jacobi_loss_manual(self, z_n: torch.Tensor) -> torch.Tensor:
        ...
        get_jacobian_func = getattr(self.L_tensor, "get_jacobian", None) if hasattr(self, "L_tensor") else None
        return jacobi_loss_manual(self._forward_L_tensor_for_jacobi, z_n, get_jacobian_func=get_jacobian_func)
    ...
    def jacobi_loss_og(self, z_n: torch.Tensor) -> torch.Tensor:
        ...
        return jacobi_loss_og(self._forward_L_tensor_for_jacobi, z_n)
